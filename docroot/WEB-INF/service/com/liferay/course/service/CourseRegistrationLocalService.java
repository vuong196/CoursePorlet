...
/**
 * Provides the local service interface for CourseRegistration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ces
 * @see CourseRegistrationLocalServiceUtil
...
public interface CourseRegistrationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CourseRegistrationLocalServiceUtil} to access the course registration local service. Add custom service methods to {@link com.liferay.course.service.impl.CourseRegistrationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
